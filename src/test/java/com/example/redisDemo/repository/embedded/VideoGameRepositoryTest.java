package com.example.redisDemo.repository.embedded;

import com.example.redisDemo.config.RedisEmbeddedServer;
...
@DirtiesContext
@DataRedisTest
@Import(RedisEmbeddedServer.class)
@DisplayName("VideoGame Repository Embedded")
